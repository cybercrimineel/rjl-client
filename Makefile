...
LIBUSB_CFLAGS := -DLIBUSB_DESCRIBE=\"\" -DLIBUSB_MAJOR=1 -DLIBUSB_MINOR=1 -DLIBUSB_MICRO=1 -DLIBUSB_RC=\"\"
...
ifneq (,$(findstring softfloat,$(platform)))
   ...
   CFLAGS += -D__WIN32__ -D__LIBRETRO__
	LIBUSB = 1
	LIBUSB_WINDOWS = 1
	LIBUSB_CFLAGS += -DOS_WINDOWS -DENABLE_DEBUG_LOGGING -DENABLE_LOGGING -DHAVE_GETTIMEOFDAY -DHAVE_INTTYPES_H -DHAVE_MEMORY_H -DHAVE_STDINT_H -DHAVE_STDLIB_H -DHAVE_STRINGS_H -DHAVE_STRING_H -DHAVE_SYS_STAT_H -DHAVE_SYS_TIME_H -DHAVE_SYS_TYPES_H -DHAVE_UNISTD_H -DPOLL_NFDS_TYPE='unsigned int' -DSTDC_HEADERS -D_GNU_SOURCE
endif
